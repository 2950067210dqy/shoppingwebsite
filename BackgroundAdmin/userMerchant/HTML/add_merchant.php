...
<div class="information">
	<div class="modal-title"
		...
		<span class="text-left"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加商家</span>
		<span style="margin-left: 80%"><a style="display: inline" class=" btn btn-default text-right"
		                                  href="usermerchant.php">返回</a></span>
	</div>
	
	<div class="admininformation">
		<form method="post" action="../PHP/add_merchant_check.php" enctype="multipart/form-data" id="form">

...
<div class="information">
	<div class="modal-title"
		...
		<span class="text-left"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>更新商家</span>
	...
	<div class="admininformation">
		<form method="post" action="../PHP/update_merchant_check.php?id=<?php echo $_GET['id'] ?>"

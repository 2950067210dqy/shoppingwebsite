...
<div class="information">
	<div class="modal-title"
		...
		<span class="text-left"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span>添加用户</span>
	...
	<div class="admininformation">
		<form method="post" action="../PHP/add_user_check.php" enctype="multipart/form-data" id="form">

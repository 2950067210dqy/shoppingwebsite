...
$sql = "select id from shop,user where shop.user_id=user.id";
//			根据搜索结果查询
		...
		<form class="navbar-form navbar-right" style="margin-right: 2%;" action="" method="get">
			<div class="text-center" STYLE="position: relative">
				...
				<select class="form-control" name="sel">
					...
					<option value="shop_sign_time">店铺创建时间</option>
				</select>
			...
			<form action="../PHP/delete_shop.php" method="post">
				...
				if ($result -> num_rows > 0) {
					...
					if (isset($_GET['searchtext']) && isset($_GET['sel'])) {
						...
						echo "<tr><td colspan='12' class='text-center'>暂无店铺，快去添加吧！<td><tr>";
					}
				}
				$result -> free_result();
				?>

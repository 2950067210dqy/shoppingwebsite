...
if (mysqli_num_rows($result)>0){
	...
	$_SESSION['sign_time'] = $row['sign_time'];
//	$_SESSION['logoin']=$_POST['logoin'];
	...
	if ($_POST['isadmin'] == 'false') {
        ...
        location.assign('../HTML/chooseLoginHTML.php');</script>";
	} elseif ($_POST['isadmin'] == 'merchant') {
		echo "<script type='text/javascript'> alert(\"亲爱的{$row['name']}商家好久不见，您终于来了，登录成功\");
        location.assign('../HTML/chooseLoginHTML.php');</script>";
	}

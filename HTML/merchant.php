...
$sql = "select shop_id from shop where user_id= {$_GET['id']}";
	...
	<table>
		...
		<div class="container" style="margin-top: 1%">
			...
			<div class="row">
				...
				<!--			信息容器-->
				<?php
				$sql = "select * from shop where user_id={$_GET['id']}";
				...
				while ($row = $result -> fetch_assoc()) {
					...
					<div class="col-sm-4 col-xs-6 col-md-2">
						<div class="thumbnail" style="height: 380px">
							<a href="shop.php?id=<?php echo $row['shop_id']; ?>"><img
									src="<?php echo $row['shop_img_addr']; ?>" height="104"></a>
							<div class="caption">
								<p>
									<a href="shop.php?id=<?php echo $row['shop_id']; ?>"
									   class="item_title"><?php if (strlen($row['shop_text']) > 150) echo substr($row['shop_text'] , 0 , 150) . '....'; else echo $row['shop_text']; ?></a>
								</p>
								<p><a href="shop.php?id=<?php echo $row['shop_id']; ?>" class="item_merchant"><font
									...
									<span class="item_merchant_place"> <a
											href="shopphp?id=<?php echo $row['shop_id'] ?>">类型：<?php echo $row['shop_maintype'] ?> &nbsp; &nbsp; &nbsp; &nbsp; <?php echo $row['shop_sign_time'] ?></a></span>
								</p>
							</div>
						</div>
					</div>

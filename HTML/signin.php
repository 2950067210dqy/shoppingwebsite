...
<div class="main">
    ...
    <div class="information">
        <div class="position">
            ...
            ?>
            <span>您当前的位置: <a href="../PHP/signinLocation.php? id=index_back">首页</a> <—— <a href="../PHP/signinLocation.php? id=logoin_back">登陆</a><——注册</span>
        </div>
        <div class="logoinformation">
            <div style="width: 60%;margin :0 auto; height: 20px;text-align: center;color: rgb(241,1,128)"><h3 style="margin-top: 7px">注册账号</h3> </div>
            <form method="post" action="../PHP/sigin_save.php" enctype="multipart/form-data">
                <br>
                <input type="file" name="headimg">
                <br>
                <p id="headimgwarn">请上传图片当做您的头像</p>
                <input type="text" maxlength="10" minlength="4" name="id" id="id" placeholder="请输入账号 (由4-10位字母或符号组成)" onkeyup="check(this.name)">
                <br>
                <p id="idwarn" ></p>
                <input type="text"  name="email" minlength="7" maxlength="50" id="email" placeholder="请输入邮箱" onkeyup="check(this.name)">
                <br>
                <p id="emailwarn" ></p>
                ...
                <br>
                <p  id="passwordwarn"></p>
                <input type="password" maxlength="12"  minlength="6"  name="passwordagain"   id="passwordagain" placeholder="再次输入上方的密码" onkeyup="check(this.name)">
                <br>
                ...
                <br>
                <span style="13px;color: #999999;margin-left: 30px;">普通用户</span></pan><input type="radio" name="admin" checked="checked" value="false" >  <span style="13px;color:#999999;margin-left: 45px;">管理员</span><input type="radio" name="admin" value="true"  >

...
<div class="main">
    ...
    <div class="information">
        ...
        <form method="post" action="../PHP/login_check.php?beforeAddre=<?php echo urlencode($_SERVER['HTTP_REFERER']);?>">
            ...
            <br>
            <input type="password" maxlength="50" name="password" placeholder="密码（不大于10位）" id="password" onkeyup="check(this.name)">
            <br>

...
<div class="information">
	<div class="modal-title"
		...
		<span class="text-left"><span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>更新店铺</span>
	...
	<div class="admininformation">
		<form method="post" action="../PHP/update_shop_check.php?id=<?php echo $id ?>" enctype="multipart/form-data"
		      id="form">
					...
					<td>
						<div class="form-group" id="shop_name_group">
							...
							<input type="text" name="shop_name" id="shop_name" class="form-control has-error "
							       placeholder="请输入店铺名" value="<?php echo $row['shop_name'] ?>">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group" id="shop_maintype_group">
							...
							<input type="text" name="shop_maintype" id="shop_maintype" class="form-control"
							       value="<?php echo $row['shop_maintype'] ?>">
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group" id="shop_text_group">
							...
							<textarea name="shop_text" id="shop_text" class="form-control"
							          rows="10"><?php echo $row['shop_text'] ?></textarea>
						</div>
					</td>
				</tr>
				<tr>
...
<script>
	$(function () {
		$('#form').on('submit', function () {
			...
			if ($('#shop_text').val() && $('#shop_maintype').val() && $('#shop_name').val()) {
				return true;
			} else {
				return false;
			}
